...
cv = pickle.load(open(r"D:\Youtube Comment Analysis\Youtube_comments_sentimental_analysis-master\vectorizer.pkl", 'rb'))
...
# loading the model
loaded_model = pickle.load(open(r"D:\Youtube Comment Analysis\Youtube_comments_sentimental_analysis-master\xgboost_model.sav", 'rb'))
...
def extract_video_id(url):
    ...
    video_id_match = re.search(r"(?:v=|v\/|vi\/|videos\/|embed\/|youtu.be\/|watch\?v=|\?v=|&v=|\?id=)([a-zA-Z0-9_-]+)",
                               url)
...
def ytlink():
    ...
    API_KEY = 'AIzaSyCDrRvCgJtINwE9dYB8MR-0_qxA8F2xed8'
    # title
